...
# Pop - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#202020', '#eb008a', '#37b349', '#f29333', '#0e5a94', '#b31e8d', '#00aabb', '#e0e0e0', '#303030', '#eb008a', '#37b349', '#f8ca12', '#0e5a94', '#b31e8d', '#00aabb', '#ffffff']"
...
gset string palette "#202020:#eb008a:#37b349:#f29333:#0e5a94:#b31e8d:#00aabb:#e0e0e0:#303030:#eb008a:#37b349:#f8ca12:#0e5a94:#b31e8d:#00aabb:#ffffff"
