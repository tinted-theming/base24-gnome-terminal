...
# Solarized Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#073642', '#dc322f', '#859900', '#cb4b16', '#268bd2', '#6c71c4', '#2aa198', '#eee8d5', '#586e75', '#dc322f', '#859900', '#b58900', '#268bd2', '#6c71c4', '#2aa198', '#fdf6e3']"
...
gset string palette "#073642:#dc322f:#859900:#cb4b16:#268bd2:#6c71c4:#2aa198:#eee8d5:#586e75:#dc322f:#859900:#b58900:#268bd2:#6c71c4:#2aa198:#fdf6e3"
