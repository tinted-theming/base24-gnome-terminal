...
# Default Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#282828', '#ab4642', '#a1b56c', '#dc9656', '#7cafc2', '#ba8baf', '#86c1b9', '#e8e8e8', '#383838', '#ab4642', '#a1b56c', '#f7ca88', '#7cafc2', '#ba8baf', '#86c1b9', '#f8f8f8']"
...
gset string palette "#282828:#ab4642:#a1b56c:#dc9656:#7cafc2:#ba8baf:#86c1b9:#e8e8e8:#383838:#ab4642:#a1b56c:#f7ca88:#7cafc2:#ba8baf:#86c1b9:#f8f8f8"
