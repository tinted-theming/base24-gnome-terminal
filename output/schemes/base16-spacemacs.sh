...
# Spacemacs - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#282828', '#f2241f', '#67b11d', '#ffa500', '#4f97d7', '#a31db1', '#2d9574', '#e8e8e8', '#444155', '#f2241f', '#67b11d', '#b1951d', '#4f97d7', '#a31db1', '#2d9574', '#f8f8f8']"
...
gset string palette "#282828:#f2241f:#67b11d:#ffa500:#4f97d7:#a31db1:#2d9574:#e8e8e8:#444155:#f2241f:#67b11d:#b1951d:#4f97d7:#a31db1:#2d9574:#f8f8f8"
