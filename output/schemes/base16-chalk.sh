...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#202020', '#fb9fb1', '#acc267', '#eda987', '#6fc2ef', '#e1a3ee', '#12cfc0', '#e0e0e0', '#303030', '#fb9fb1', '#acc267', '#ddb26f', '#6fc2ef', '#e1a3ee', '#12cfc0', '#f5f5f5']"
...
gset string palette "#202020:#fb9fb1:#acc267:#eda987:#6fc2ef:#e1a3ee:#12cfc0:#e0e0e0:#303030:#fb9fb1:#acc267:#ddb26f:#6fc2ef:#e1a3ee:#12cfc0:#f5f5f5"
