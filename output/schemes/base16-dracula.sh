...
# Dracula - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#3a3c4e', '#ea51b2', '#ebff87', '#b45bcf', '#62d6e8', '#b45bcf', '#a1efe4', '#f1f2f8', '#4d4f68', '#ea51b2', '#ebff87', '#00f769', '#62d6e8', '#b45bcf', '#a1efe4', '#f7f7fb']"
        ...
        dset cursor-foreground-color "'#3a3c4e'"
...
gset string palette "#3a3c4e:#ea51b2:#ebff87:#b45bcf:#62d6e8:#b45bcf:#a1efe4:#f1f2f8:#4d4f68:#ea51b2:#ebff87:#00f769:#62d6e8:#b45bcf:#a1efe4:#f7f7fb"
...
gset string cursor-foreground-color "'#3a3c4e'"
