...
# Brush Trees - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#C9DBDC', '#b38686', '#87b386', '#d8bba2', '#868cb3', '#b386b2', '#86b3b3', '#5A6D7A', '#B0C5C8', '#b38686', '#87b386', '#aab386', '#868cb3', '#b386b2', '#86b3b3', '#485867']"
        ...
        dset cursor-foreground-color "'#C9DBDC'"
...
gset string palette "#C9DBDC:#b38686:#87b386:#d8bba2:#868cb3:#b386b2:#86b3b3:#5A6D7A:#B0C5C8:#b38686:#87b386:#aab386:#868cb3:#b386b2:#86b3b3:#485867"
...
gset string cursor-foreground-color "'#C9DBDC'"
