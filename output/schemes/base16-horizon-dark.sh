...
# Horizon Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#232530', '#E93C58', '#EFAF8E', '#E58D7D', '#DF5273', '#B072D1', '#24A8B4', '#DCDFE4', '#2E303E', '#E93C58', '#EFAF8E', '#EFB993', '#DF5273', '#B072D1', '#24A8B4', '#E3E6EE']"
        ...
        dset cursor-foreground-color "'#232530'"
...
gset string palette "#232530:#E93C58:#EFAF8E:#E58D7D:#DF5273:#B072D1:#24A8B4:#DCDFE4:#2E303E:#E93C58:#EFAF8E:#EFB993:#DF5273:#B072D1:#24A8B4:#E3E6EE"
...
gset string cursor-foreground-color "'#232530'"
