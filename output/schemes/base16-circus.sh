...
# Circus - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#202020', '#dc657d', '#84b97c', '#4bb1a7', '#639ee4', '#b888e2', '#4bb1a7', '#808080', '#303030', '#dc657d', '#84b97c', '#c3ba63', '#639ee4', '#b888e2', '#4bb1a7', '#ffffff']"
...
gset string palette "#202020:#dc657d:#84b97c:#4bb1a7:#639ee4:#b888e2:#4bb1a7:#808080:#303030:#dc657d:#84b97c:#c3ba63:#639ee4:#b888e2:#4bb1a7:#ffffff"
