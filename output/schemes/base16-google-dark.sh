...
# Google Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#282a2e', '#CC342B', '#198844', '#F96A38', '#3971ED', '#A36AC7', '#3971ED', '#e0e0e0', '#373b41', '#CC342B', '#198844', '#FBA922', '#3971ED', '#A36AC7', '#3971ED', '#ffffff']"
...
gset string palette "#282a2e:#CC342B:#198844:#F96A38:#3971ED:#A36AC7:#3971ED:#e0e0e0:#373b41:#CC342B:#198844:#FBA922:#3971ED:#A36AC7:#3971ED:#ffffff"
