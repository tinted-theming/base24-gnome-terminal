...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#232530', '#E95678', '#29D398', '#FAB795', '#26BBD9', '#EE64AC', '#59E1E3', '#DCDFE4', '#2E303E', '#E95678', '#29D398', '#FAC29A', '#26BBD9', '#EE64AC', '#59E1E3', '#E3E6EE']"
...
gset string palette "#232530:#E95678:#29D398:#FAB795:#26BBD9:#EE64AC:#59E1E3:#DCDFE4:#2E303E:#E95678:#29D398:#FAC29A:#26BBD9:#EE64AC:#59E1E3:#E3E6EE"
