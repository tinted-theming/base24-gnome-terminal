...
# Nova - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#556873', '#83AFE5', '#7FC1CA', '#7FC1CA', '#83AFE5', '#9A93E1', '#F2C38F', '#899BA6', '#6A7D89', '#83AFE5', '#7FC1CA', '#A8CE93', '#83AFE5', '#9A93E1', '#F2C38F', '#556873']"
        ...
        dset cursor-foreground-color "'#556873'"
...
gset string palette "#556873:#83AFE5:#7FC1CA:#7FC1CA:#83AFE5:#9A93E1:#F2C38F:#899BA6:#6A7D89:#83AFE5:#7FC1CA:#A8CE93:#83AFE5:#9A93E1:#F2C38F:#556873"
...
gset string cursor-foreground-color "'#556873'"
