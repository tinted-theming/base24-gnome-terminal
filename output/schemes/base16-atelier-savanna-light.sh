...
# Atelier Savanna Light - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#dfe7e2', '#b16139', '#489963', '#9f713c', '#478c90', '#55859b', '#1c9aa0', '#232a25', '#87928a', '#b16139', '#489963', '#a07e3b', '#478c90', '#55859b', '#1c9aa0', '#171c19']"
        ...
        dset cursor-foreground-color "'#dfe7e2'"
...
gset string palette "#dfe7e2:#b16139:#489963:#9f713c:#478c90:#55859b:#1c9aa0:#232a25:#87928a:#b16139:#489963:#a07e3b:#478c90:#55859b:#1c9aa0:#171c19"
...
gset string cursor-foreground-color "'#dfe7e2'"
