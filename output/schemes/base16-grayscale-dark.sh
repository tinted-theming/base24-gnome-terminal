...
# Grayscale Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#252525', '#7c7c7c', '#8e8e8e', '#999999', '#686868', '#747474', '#868686', '#e3e3e3', '#464646', '#7c7c7c', '#8e8e8e', '#a0a0a0', '#686868', '#747474', '#868686', '#f7f7f7']"
        ...
        dset cursor-foreground-color "'#252525'"
...
gset string palette "#252525:#7c7c7c:#8e8e8e:#999999:#686868:#747474:#868686:#e3e3e3:#464646:#7c7c7c:#8e8e8e:#a0a0a0:#686868:#747474:#868686:#f7f7f7"
...
gset string cursor-foreground-color "'#252525'"
