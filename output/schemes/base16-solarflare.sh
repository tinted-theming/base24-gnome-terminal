...
# Solar Flare - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#222E38', '#EF5253', '#7CC844', '#E66B2B', '#33B5E1', '#A363D5', '#52CBB0', '#E8E9ED', '#586875', '#EF5253', '#7CC844', '#E4B51C', '#33B5E1', '#A363D5', '#52CBB0', '#F5F7FA']"
        ...
        dset cursor-foreground-color "'#222E38'"
...
gset string palette "#222E38:#EF5253:#7CC844:#E66B2B:#33B5E1:#A363D5:#52CBB0:#E8E9ED:#586875:#EF5253:#7CC844:#E4B51C:#33B5E1:#A363D5:#52CBB0:#F5F7FA"
...
gset string cursor-foreground-color "'#222E38'"
