...
# Edge Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#88909f', '#e77171', '#a1bf78', '#e77171', '#73b3e7', '#d390e7', '#5ebaa5', '#d390e7', '#b7bec9', '#e77171', '#a1bf78', '#dbb774', '#73b3e7', '#d390e7', '#5ebaa5', '#3e4249']"
        ...
        dset cursor-foreground-color "'#88909f'"
...
gset string palette "#88909f:#e77171:#a1bf78:#e77171:#73b3e7:#d390e7:#5ebaa5:#d390e7:#b7bec9:#e77171:#a1bf78:#dbb774:#73b3e7:#d390e7:#5ebaa5:#3e4249"
...
gset string cursor-foreground-color "'#88909f'"
