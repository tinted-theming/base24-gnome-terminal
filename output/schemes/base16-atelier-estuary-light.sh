...
# Atelier Estuary Light - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#e7e6df', '#ba6236', '#7d9726', '#ae7313', '#36a166', '#5f9182', '#5b9d48', '#302f27', '#929181', '#ba6236', '#7d9726', '#a5980d', '#36a166', '#5f9182', '#5b9d48', '#22221b']"
        ...
        dset cursor-foreground-color "'#e7e6df'"
...
gset string palette "#e7e6df:#ba6236:#7d9726:#ae7313:#36a166:#5f9182:#5b9d48:#302f27:#929181:#ba6236:#7d9726:#a5980d:#36a166:#5f9182:#5b9d48:#22221b"
...
gset string cursor-foreground-color "'#e7e6df'"
