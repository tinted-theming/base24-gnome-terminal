...
# Gigavolt - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#2d303d', '#ff661a', '#f2e6a9', '#19f988', '#40bfff', '#ae94f9', '#fb6acb', '#eff0f9', '#5a576e', '#ff661a', '#f2e6a9', '#ffdc2d', '#40bfff', '#ae94f9', '#fb6acb', '#f2fbff']"
        ...
        dset cursor-foreground-color "'#2d303d'"
...
gset string palette "#2d303d:#ff661a:#f2e6a9:#19f988:#40bfff:#ae94f9:#fb6acb:#eff0f9:#5a576e:#ff661a:#f2e6a9:#ffdc2d:#40bfff:#ae94f9:#fb6acb:#f2fbff"
...
gset string cursor-foreground-color "'#2d303d'"
