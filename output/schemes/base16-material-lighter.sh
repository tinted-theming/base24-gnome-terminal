...
# Material Lighter - Gnome Terminal color scheme install script for Base24
# Nate Peterson
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#E7EAEC', '#FF5370', '#91B859', '#F76D47', '#6182B8', '#7C4DFF', '#39ADB5', '#80CBC4', '#CCEAE7', '#FF5370', '#91B859', '#FFB62C', '#6182B8', '#7C4DFF', '#39ADB5', '#FFFFFF']"
        ...
        dset cursor-foreground-color "'#E7EAEC'"
...
gset string palette "#E7EAEC:#FF5370:#91B859:#F76D47:#6182B8:#7C4DFF:#39ADB5:#80CBC4:#CCEAE7:#FF5370:#91B859:#FFB62C:#6182B8:#7C4DFF:#39ADB5:#FFFFFF"
...
gset string cursor-foreground-color "'#E7EAEC'"
