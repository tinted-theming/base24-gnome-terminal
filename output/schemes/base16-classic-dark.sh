...
# Classic Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#202020', '#AC4142', '#90A959', '#D28445', '#6A9FB5', '#AA759F', '#75B5AA', '#E0E0E0', '#303030', '#AC4142', '#90A959', '#F4BF75', '#6A9FB5', '#AA759F', '#75B5AA', '#F5F5F5']"
...
gset string palette "#202020:#AC4142:#90A959:#D28445:#6A9FB5:#AA759F:#75B5AA:#E0E0E0:#303030:#AC4142:#90A959:#F4BF75:#6A9FB5:#AA759F:#75B5AA:#F5F5F5"
