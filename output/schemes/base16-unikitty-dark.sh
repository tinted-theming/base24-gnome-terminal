...
# Unikitty Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#4a464d', '#d8137f', '#17ad98', '#d65407', '#796af5', '#bb60ea', '#149bda', '#d8d7da', '#666369', '#d8137f', '#17ad98', '#dc8a0e', '#796af5', '#bb60ea', '#149bda', '#f5f4f7']"
        ...
        dset cursor-foreground-color "'#4a464d'"
...
gset string palette "#4a464d:#d8137f:#17ad98:#d65407:#796af5:#bb60ea:#149bda:#d8d7da:#666369:#d8137f:#17ad98:#dc8a0e:#796af5:#bb60ea:#149bda:#f5f4f7"
...
gset string cursor-foreground-color "'#4a464d'"
