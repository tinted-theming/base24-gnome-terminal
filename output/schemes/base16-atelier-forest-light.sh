...
# Atelier Forest Light - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#e6e2e0', '#f22c40', '#7b9726', '#df5320', '#407ee7', '#6666ea', '#3d97b8', '#2c2421', '#a8a19f', '#f22c40', '#7b9726', '#c38418', '#407ee7', '#6666ea', '#3d97b8', '#1b1918']"
        ...
        dset cursor-foreground-color "'#e6e2e0'"
...
gset string palette "#e6e2e0:#f22c40:#7b9726:#df5320:#407ee7:#6666ea:#3d97b8:#2c2421:#a8a19f:#f22c40:#7b9726:#c38418:#407ee7:#6666ea:#3d97b8:#1b1918"
...
gset string cursor-foreground-color "'#e6e2e0'"
