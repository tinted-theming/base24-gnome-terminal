...
# Gruvbox light, medium - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#ebdbb2', '#9d0006', '#79740e', '#af3a03', '#076678', '#8f3f71', '#427b58', '#3c3836', '#d5c4a1', '#9d0006', '#79740e', '#b57614', '#076678', '#8f3f71', '#427b58', '#282828']"
        ...
        dset cursor-foreground-color "'#ebdbb2'"
...
gset string palette "#ebdbb2:#9d0006:#79740e:#af3a03:#076678:#8f3f71:#427b58:#3c3836:#d5c4a1:#9d0006:#79740e:#b57614:#076678:#8f3f71:#427b58:#282828"
...
gset string cursor-foreground-color "'#ebdbb2'"
