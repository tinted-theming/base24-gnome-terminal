...
# Tomorrow Night - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#393939', '#f2777a', '#99cc99', '#f99157', '#6699cc', '#cc99cc', '#66cccc', '#e0e0e0', '#515151', '#f2777a', '#99cc99', '#ffcc66', '#6699cc', '#cc99cc', '#66cccc', '#ffffff']"
        ...
        dset cursor-foreground-color "'#393939'"
...
gset string palette "#393939:#f2777a:#99cc99:#f99157:#6699cc:#cc99cc:#66cccc:#e0e0e0:#515151:#f2777a:#99cc99:#ffcc66:#6699cc:#cc99cc:#66cccc:#ffffff"
...
gset string cursor-foreground-color "'#393939'"
