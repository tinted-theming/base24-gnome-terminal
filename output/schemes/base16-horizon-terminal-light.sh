...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#FADAD1', '#E95678', '#29D398', '#F9CEC3', '#26BBD9', '#EE64AC', '#59E1E3', '#302C2D', '#F9CBBE', '#E95678', '#29D398', '#FADAD1', '#26BBD9', '#EE64AC', '#59E1E3', '#201C1D']"
...
gset string palette "#FADAD1:#E95678:#29D398:#F9CEC3:#26BBD9:#EE64AC:#59E1E3:#302C2D:#F9CBBE:#E95678:#29D398:#FADAD1:#26BBD9:#EE64AC:#59E1E3:#201C1D"
