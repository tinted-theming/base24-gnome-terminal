...
# Classic Light - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#E0E0E0', '#AC4142', '#90A959', '#D28445', '#6A9FB5', '#AA759F', '#75B5AA', '#202020', '#D0D0D0', '#AC4142', '#90A959', '#F4BF75', '#6A9FB5', '#AA759F', '#75B5AA', '#151515']"
...
gset string palette "#E0E0E0:#AC4142:#90A959:#D28445:#6A9FB5:#AA759F:#75B5AA:#202020:#D0D0D0:#AC4142:#90A959:#F4BF75:#6A9FB5:#AA759F:#75B5AA:#151515"
