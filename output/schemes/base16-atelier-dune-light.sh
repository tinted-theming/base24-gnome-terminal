...
# Atelier Dune Light - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#e8e4cf', '#d73737', '#60ac39', '#b65611', '#6684e1', '#b854d4', '#1fad83', '#292824', '#a6a28c', '#d73737', '#60ac39', '#ae9513', '#6684e1', '#b854d4', '#1fad83', '#20201d']"
        ...
        dset cursor-foreground-color "'#e8e4cf'"
...
gset string palette "#e8e4cf:#d73737:#60ac39:#b65611:#6684e1:#b854d4:#1fad83:#292824:#a6a28c:#d73737:#60ac39:#ae9513:#6684e1:#b854d4:#1fad83:#20201d"
...
gset string cursor-foreground-color "'#e8e4cf'"
