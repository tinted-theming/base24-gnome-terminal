...
# Summerfruit Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#202020', '#FF0086', '#00C918', '#FD8900', '#3777E6', '#AD00A1', '#1FAAAA', '#E0E0E0', '#303030', '#FF0086', '#00C918', '#ABA800', '#3777E6', '#AD00A1', '#1FAAAA', '#FFFFFF']"
...
gset string palette "#202020:#FF0086:#00C918:#FD8900:#3777E6:#AD00A1:#1FAAAA:#E0E0E0:#303030:#FF0086:#00C918:#ABA800:#3777E6:#AD00A1:#1FAAAA:#FFFFFF"
