...
# Woodland - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#302b25', '#d35c5c', '#b7ba53', '#ca7f32', '#88a4d3', '#bb90e2', '#6eb958', '#d7c8bc', '#48413a', '#d35c5c', '#b7ba53', '#e0ac16', '#88a4d3', '#bb90e2', '#6eb958', '#e4d4c8']"
        ...
        dset cursor-foreground-color "'#302b25'"
...
gset string palette "#302b25:#d35c5c:#b7ba53:#ca7f32:#88a4d3:#bb90e2:#6eb958:#d7c8bc:#48413a:#d35c5c:#b7ba53:#e0ac16:#88a4d3:#bb90e2:#6eb958:#e4d4c8"
...
gset string cursor-foreground-color "'#302b25'"
