...
# Horizon Light - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#FADAD1', '#F7939B', '#94E1B0', '#F6661E', '#DA103F', '#1D8991', '#DC3318', '#302C2D', '#F9CBBE', '#F7939B', '#94E1B0', '#FBE0D9', '#DA103F', '#1D8991', '#DC3318', '#201C1D']"
        ...
        dset cursor-foreground-color "'#FADAD1'"
...
gset string palette "#FADAD1:#F7939B:#94E1B0:#F6661E:#DA103F:#1D8991:#DC3318:#302C2D:#F9CBBE:#F7939B:#94E1B0:#FBE0D9:#DA103F:#1D8991:#DC3318:#201C1D"
...
gset string cursor-foreground-color "'#FADAD1'"
