...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#323537', '#cf6a4c', '#8f9d6a', '#cda869', '#7587a6', '#9b859d', '#afc4db', '#c3c3c3', '#464b50', '#cf6a4c', '#8f9d6a', '#f9ee98', '#7587a6', '#9b859d', '#afc4db', '#ffffff']"
        ...
        dset cursor-foreground-color "'#323537'"
...
gset string palette "#323537:#cf6a4c:#8f9d6a:#cda869:#7587a6:#9b859d:#afc4db:#c3c3c3:#464b50:#cf6a4c:#8f9d6a:#f9ee98:#7587a6:#9b859d:#afc4db:#ffffff"
...
gset string cursor-foreground-color "'#323537'"
