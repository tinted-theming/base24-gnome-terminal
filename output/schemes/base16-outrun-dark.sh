...
# Outrun Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#20204A', '#FF4242', '#59F176', '#FC8D28', '#66B0FF', '#F10596', '#0EF0F0', '#E0E0FF', '#30305A', '#FF4242', '#59F176', '#F3E877', '#66B0FF', '#F10596', '#0EF0F0', '#F5F5FF']"
        ...
        dset cursor-foreground-color "'#20204A'"
...
gset string palette "#20204A:#FF4242:#59F176:#FC8D28:#66B0FF:#F10596:#0EF0F0:#E0E0FF:#30305A:#FF4242:#59F176:#F3E877:#66B0FF:#F10596:#0EF0F0:#F5F5FF"
...
gset string cursor-foreground-color "'#20204A'"
