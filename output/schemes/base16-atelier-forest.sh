...
# Atelier Forest - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#2c2421', '#f22c40', '#7b9726', '#df5320', '#407ee7', '#6666ea', '#3d97b8', '#e6e2e0', '#68615e', '#f22c40', '#7b9726', '#c38418', '#407ee7', '#6666ea', '#3d97b8', '#f1efee']"
        ...
        dset cursor-foreground-color "'#2c2421'"
...
gset string palette "#2c2421:#f22c40:#7b9726:#df5320:#407ee7:#6666ea:#3d97b8:#e6e2e0:#68615e:#f22c40:#7b9726:#c38418:#407ee7:#6666ea:#3d97b8:#f1efee"
...
gset string cursor-foreground-color "'#2c2421'"
