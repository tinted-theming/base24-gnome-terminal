...
# Macintosh - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#404040', '#dd0907', '#1fb714', '#ff6403', '#0000d3', '#4700a5', '#02abea', '#c0c0c0', '#404040', '#dd0907', '#1fb714', '#fbf305', '#0000d3', '#4700a5', '#02abea', '#ffffff']"
        ...
        dset cursor-foreground-color "'#404040'"
...
gset string palette "#404040:#dd0907:#1fb714:#ff6403:#0000d3:#4700a5:#02abea:#c0c0c0:#404040:#dd0907:#1fb714:#fbf305:#0000d3:#4700a5:#02abea:#ffffff"
...
gset string cursor-foreground-color "'#404040'"
