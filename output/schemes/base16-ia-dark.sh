...
# iA Dark - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#222222', '#d88568', '#83a471', '#d86868', '#8eccdd', '#b98eb2', '#7c9cae', '#e8e8e8', '#1d414d', '#d88568', '#83a471', '#b99353', '#8eccdd', '#b98eb2', '#7c9cae', '#f8f8f8']"
...
gset string palette "#222222:#d88568:#83a471:#d86868:#8eccdd:#b98eb2:#7c9cae:#e8e8e8:#1d414d:#d88568:#83a471:#b99353:#8eccdd:#b98eb2:#7c9cae:#f8f8f8"
