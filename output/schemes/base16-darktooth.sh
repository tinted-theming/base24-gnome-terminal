...
# Darktooth - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#32302F', '#FB543F', '#95C085', '#FE8625', '#0D6678', '#8F4673', '#8BA59B', '#D5C4A1', '#504945', '#FB543F', '#95C085', '#FAC03B', '#0D6678', '#8F4673', '#8BA59B', '#FDF4C1']"
...
gset string palette "#32302F:#FB543F:#95C085:#FE8625:#0D6678:#8F4673:#8BA59B:#D5C4A1:#504945:#FB543F:#95C085:#FAC03B:#0D6678:#8F4673:#8BA59B:#FDF4C1"
